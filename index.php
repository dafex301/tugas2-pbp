    ...
    <div class="flex flex-col">
      ...
      <nav class="flex justify-around py-4 bg-white/80
        ...
        <div class="flex items-center space-x-5">
          ...
          <!-- Logout -->
          <a href="action-logout.php" class="flex text-gray-600 hover:text-blue-500
                    cursor-pointer transition-colors duration-300">
      ...
      <div class="m-12 mx-64">
        <button class="fortnite-btn flex items-center justify-center h-32 w-64">
          <a href="question.php?id=1" class="fortnite-btn-inner p-3 pt-5 w-11/12 text-5xl truncate">Start</a>
        </button>
      </div>
    </div>
</body>
